...
motions = [
    [0.4, 0, 1.5],            # Motion 1, straight
    [0.0, pi/2, 2.5],            # Motion 2, turn left
    [0.4, 0, 1.5],            # Motion 3, straight
    [0.0, pi/2, 2.5],            # Motion 4, turn left
    [0.4, 0, 1.5],            # Motion 5, straight 
    [0.0, -pi/2, 2.5],            # Motion 6, turn right
    [0.4, 0, 1.5],            # Motion 7, straight
    [0.0, -pi/2, 2.5],            # Motion 8, turn right
    [0.4, 0, 1.5],            # Motion 9, straight
    [0, 0, 0],            # Motion 1, straight
]
...
for  count, motion in enumerate(motions):
    ...
    log.tmpFile(motion[0], "Forward Velocity")
    log.tmpFile(motion[1], "Angular Velocity")
